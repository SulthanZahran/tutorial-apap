...
public class ResepRestController {
    ...
    private ResponseEntity<String> deleteResep(@PathVariable("noResep") Long noResep){
        try{
            ...
            throw new ResponseStatusException(HttpStatus.NOT_FOUND, "Resep with Number " + String.valueOf(noResep) + " not found!");
        } catch (UnsupportedOperationException e){
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "Resep still has Obat, please delete the Obat first!");
        }
    }
